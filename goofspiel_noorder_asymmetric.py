...
GAME_TYPE = get_game_type("python_goofspiel_noorder_asymmetric", "Python Goofspiel No Order Asymmetric")


class GoofspielNoOrderAsymmetricGame(GoofspielGameBase):
    ...
    def make_py_observer(self, iig_obs_type=None, params=None):
        ...
        return GoofspielNoOrderAsymmetricObserver(
            iig_obs_type or pyspiel.IIGObservationType(perfect_recall=False),
            self._abstract_player, self._num_players, self._num_cards, self._num_turns, self.shift, params)


class GoofspielNoOrderAsymmetricObserver(GoofspielObserverBase):
...
pyspiel.register_game(GAME_TYPE, GoofspielNoOrderAsymmetricGame)
