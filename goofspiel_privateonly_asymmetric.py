...
GAME_TYPE = get_game_type("python_goofspiel_privateonly_asymmetric", "Python Goofspiel Private Only Asymmetric")


class GoofspielPrivateOnlyAsymmetricGame(GoofspielGameBase):
    ...
    def make_py_observer(self, iig_obs_type=None, params=None):
        ...
        return GoofspielPrivateOnlyAsymmetricObserver(
            iig_obs_type or pyspiel.IIGObservationType(perfect_recall=False),
            self._abstract_player, self._num_players, self._num_cards, self._num_turns, self.shift, params)


class GoofspielPrivateOnlyAsymmetricObserver(GoofspielObserverBase):
...
pyspiel.register_game(GAME_TYPE, GoofspielPrivateOnlyAsymmetricGame)
